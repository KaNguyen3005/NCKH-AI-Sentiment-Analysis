...
class BiLSTM(nn.Module):
    """BiLSTM classifier that produces raw logits for sentiment classes."""
    ...
    def __init__(
        ...
        # LSTM's built-in dropout is only applied between stacked LSTM layers.
    ...
    def forward(self, input_ids: Tensor, lengths: Optional[Tensor] = None) -> Tensor:
